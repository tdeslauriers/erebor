...
S2S_AUTH_CLIENT_ID=$(op read "op://world_site/erebor_service_container_prod/client_id")
S2S_AUTH_CLIENT_SECRET=$(op read "op://world_site/erebor_service_container_prod/password")
